          ...
          var e = {
              ...
              renderPrev: function (e) {
                return t(document.createElement("span"))
                  .addClass("inputarrow-prev")
                  .html("<")
                  .insertBefore(e);
              },
              renderNext: function (e) {
                return t(document.createElement("span"))
                  .addClass("inputarrow-next")
                  .html(">")
                  .insertAfter(e);
              },
              encodeValue: null,
                ...
                r(i, [
                  {
                    ...
                    value: function (t) {
                      ...
                      i < this.opt.min
                        ? (i = this.opt.min)
                        : i > this.opt.max && (i = this.opt.max),
                        i !== e &&
                          (this.setValue(i),
                          this.$input.trigger("change"),
                          this.opt.onChange &&
                            this.opt.onChange.call(this, i, e));
                    },
                  },
                  {
                    key: "startCounting",
                    value: function (t) {
                      ...
                      (this.__isStarted = !0),
                        (this.__delayTimer = setTimeout(function () {
                          (e.__isCounting = !0),
                            (e.__oldValue = e.__currentValue = e.getValue()),
                            (e.__currentGrad = e.opt.gradientDefault),
                            (e.__incTimer = setInterval(function () {
                    ...
                    value: function () {
                      if ((this.__clearCounting(), this.__isCounting)) {
                        ...
                        t !== this.__oldValue &&
                          (this.$input.trigger("change"),
                          this.opt.onChange &&
                            this.opt.onChange.call(this, t, this.__oldValue));
                      }
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      this.__currentValue +=
                        t * this.opt.step * this.__currentGrad;
                      var e = this.__round(this.__currentValue),
                        i = !1;
                      e < this.opt.min
                        ? ((e = this.opt.min), (i = !0))
                        : e > this.opt.max && ((e = this.opt.max), (i = !0));
                      var n = this.getValue();
                      e !== n &&
                        (this.setValue(e),
                        this.check(),
                        this.opt.onIterate &&
                          this.opt.onIterate.call(this, e, n)),
                        i ? this.stopCounting() : this.__incGrad();
                    },
                  },
                  {
                    key: "__clearCounting",
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (
                        (this.opt.encodeValue &&
                          (t = this.opt.encodeValue.call(this, t)),
                        "" === t)
                      ) {
                        if (!this.opt.emptyOnMin)
                          throw new TypeError(
                            "Can't convert empty string to value"
                          );
                        return this.opt.min;
                      }
                      return parseFloat(
                        this.opt.comma ? t.toString().replace(/,/, ".") : t
                      );
                    },
                  },
                  {
                    key: "setValue",
                    value: function (t) {
                      this.opt.decodeValue &&
                        (t = this.opt.decodeValue.call(this, t)),
                        t === this.opt.min && this.opt.emptyOnMin
                          ? (this.input.value = "")
                          : (this.input.value = this.opt.comma
                              ? t.toString().replace(/\./, ",")
                              : t);
                    },
                  },
                  {
                    ...
                    value: function () {
                      var t = this.getValue();
                      t < this.opt.min && (t = this.opt.min),
                        t > this.opt.max && (t = this.opt.max),
                        this.setValue(t);
                    },
                  },
                  {
            ...
            inputarrow: function (e) {
              if ("string" == typeof e) {
                ...
                for (var u = 0; u < this.length; u++) {
                  ...
                  if (!h)
                    throw new Error(
                      "Can't call " + e + ": InputArrow is not initialized"
                    );
                  if (void 0 === h[e])
                    throw new Error(
                      "Can't call " + e + ": no such method or property"
                    );
                  if (/^_/.test(e))
                    throw new Error("Can't call " + e + ": it isn't public");
              ...
              for (var p = 0; p < this.length; p++) {
                ...
                if (
                  (void 0 !== _ && "" !== _ && (d.min = parseFloat(_)),
                  void 0 !== f && "" !== f && (d.max = parseFloat(f)),
                  void 0 !== g &&
                    "" !== g &&
                    "any" !== g &&
                    (d.step = parseFloat(g)),
...
$(".quantity-input-2").inputarrow({
  renderPrev: function (input) {
    return $(
      '<span class="custom-next"><i class="fal fa-minus"></i></span>'
    ).insertAfter(input);
  },
  renderNext: function (input) {
    return $(
      '<span class="custom-prev"><i class="fal fa-plus"></i></span>'
    ).insertBefore(input);
  },
